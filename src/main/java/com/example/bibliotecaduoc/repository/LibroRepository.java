...
public class LibroRepository {
    ...
    public LibroRepository(){
        listaLibros.add(new Libro(1, "9789569466638", "Fuego y Sangre", "Penguin Random House Grupo Editorial", 2018, "George R. R. Martin"));
        listaLibros.add(new Libro(2, "9789563494150", "Quique Hache: El Mall Embrujado y Otras Historias", "SM Ediciones", 2014, "Sergio Gómez"));
        ...
        listaLibros.add(new Libro(7, "9780132127426", "Effective Java", "Addison-Wesley", 2008, "Joshua Bloch"));
